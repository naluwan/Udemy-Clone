...
export const zhTW: LocalizationResource = {
  ...
  signIn: {
    ...
    alternativeMethods: {
      ...
      getHelp: {
        title: '獲取幫助',
        content:
          '如果您在登錄帳戶時遇到困難，請給我們發送電子郵件，我們將盡快讓您恢復訪問。',
        blockButton__emailSupport: '郵件支援',
      },
    },
    noAvailableMethods: {
      title: '無法登錄',
  ...
  userProfile: {
    ...
    start: {
      ...
      headerSubtitle__account: '管理您的帳戶信息',
      ...
      connectedAccountsSection: {
        ...
        subtitle__reauthorize:
          '所需的權限已更新，您可能會遇到功能限制。請重新授權此應用程式，以避免任何問題',
      ...
      dangerSection: {
        ...
        deleteAccountDescription: '刪除您的帳戶以及所有相關數據',
      },
    },
    profilePage: {
      title: '更新個人資料',
    ...
    mfaTOTPPage: {
      ...
      authenticatorApp: {
        infoText__ableToScan:
          '在您的驗證器應用中設置一個新的登錄方法，並掃描下面的二維碼將其鏈接到您的帳戶。',
        infoText__unableToScan: '在驗證器中設置一個新的登錄方法，並輸入下面提供的 Key。',
        inputLabel__unableToScan1:
          '確保啟用了基於時間或一次性密碼，然後完成鏈接您的帳戶。',
    ...
    mfaPhoneCodePage: {
      ...
      subtitle__availablePhoneNumbers: '選擇一個電話號碼來註冊短信驗證碼兩步驗證。',
      subtitle__unavailablePhoneNumbers: '沒有可用的電話號碼來註冊短信驗證碼兩步驗證。',
      successMessage:
    ...
    backupCodePage: {
      ...
      infoText2:
        '保密並安全存儲備份代碼。如果您懷疑它們已經洩露，您可以重新生成備份代碼。',
      successSubtitle: '如果您失去了驗證設備的訪問權限，您可以使用其中之一登錄您的帳戶。',
      successMessage:
        '現在已啟用備份代碼。如果您失去了驗證設備的訪問權限，您可以使用其中之一登錄您的帳戶。每個代碼只能使用一次。',
  ...
  organizationProfile: {
    start: {
      ...
      headerSubtitle__settings: '管理組織設定',
    },
    profilePage: {
      title: '組織簡介',
      subtitle: '管理組織簡介',
    ...
    invitePage: {
      ...
      detailsTitle__inviteFailed: '邀請無法發送。修復以下問題然後重試：',
  ...
  unstable__errors: {
    ...
    captcha_invalid:
      '由於安全驗證失敗，註冊未成功。請刷新頁面重試或聯繫支援獲取更多幫助。',
    form_password_pwned: '這個密碼在資料外洩中被發現，不能使用，請換一個密碼試試。',
    ...
    zxcvbn: {
      ...
      warnings: {
        ...
        simpleRepeat: '像"aaa"這樣的重複字符易被猜到。',
        extendedRepeat: '像"abcabcabc"這樣的重複字符模式易被猜到。',
  ...
  dates: {
    previous6Days:
      "上周{{ date | weekday('zh-TW','long') }} {{ date | timeString('zh-TW') }}",
